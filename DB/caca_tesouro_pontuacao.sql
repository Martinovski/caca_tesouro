...
CREATE TABLE `pontuacao` (
  ...
  ` provas` int(2) NOT NULL,
  `provas_extras` int(1) DEFAULT NULL,
  `tempo_prova` varchar(45) NOT NULL,
  `Equipe_idEquipe` int(11) NOT NULL,
  PRIMARY KEY (`idPontuacao`),
  KEY `fk_Pontuacao_Equipe1_idx` (`Equipe_idEquipe`),
  CONSTRAINT `fk_Pontuacao_Equipe1` FOREIGN KEY (`Equipe_idEquipe`) REFERENCES `equipe` (`idEquipe`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
-- Dump completed on 2017-05-23 19:28:16
